...
const PreventBack = () => {
    ...
    usePreventBack({ shouldPreventBack: true })
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-red-100">
            ...
            <h1 className="text-4xl font-bold mb-4">Prevent Back Page</h1>
            <p className="text-lg">If you press the browser back button, this page will reload.</p>
            <button
